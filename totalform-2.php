...
<div align="left"><a href="index.php"><button type="button" class="btn btn-success">หน้าหลัก</button></a>
<a href="ampher.php?y=<?php echo $y ?>"><button type="button" class="btn btn-success">ย้อนกลับ</button></a></div>
<br>
...
try {
  ...
  $i=0;
    ...
    <tr>
      ...
      <?php for($r=1;$r<=$apnum;$r++){
          ?>
      <td style="text-align:center" class="cl<?php echo $r?>"><?php echo $row["ap{$r}_value_{$y}"]?></td>
