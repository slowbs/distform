...
?>
  ...
  <script src="fuk.js"></script>
    <style type="text/css">
        input {display: block !important; padding: 0 !important; margin: 0 !important; width: 100% !important; height: 100% !important; 
...
try {
  ...
  $i=0;
    ...
    <tr>
      <td style="vertical-align: middle;" align="center"><?php echo $row['pa']?></td>
      <td style="vertical-align: middle;" align="center"><?php echo $row['lumdub']?></td>
      <td style="vertical-align: middle;"><?php echo $row['name']?></td>
      <td style="vertical-align: middle;" align="center"><?php echo $row['gane']?></td>
      <td style="vertical-align: middle;" align="center"><?php echo $row['data']?></td>
      <td style="vertical-align: middle;" align="center" class="cl6" id="koon<?php echo $row['id']?>"><?php echo $row["koon$t"]?></td>
      <td style="vertical-align: middle;" align="center" class="cl1" id="gane1_<?php echo $row['id']?>"><?php echo $row['gane1']?></td>
      <td style="vertical-align: middle;" align="center" class="cl1" id="gane2_<?php echo $row['id']?>"><?php echo $row['gane2']?></td>
      <td style="vertical-align: middle;" align="center" class="cl1" id="gane3_<?php echo $row['id']?>"><?php echo $row['gane3']?></td>
      <td style="vertical-align: middle;" align="center" class="cl1" id="gane4_<?php echo $row['id']?>"><?php echo $row['gane4']?></td>
      <td style="vertical-align: middle;" align="center" class="cl1" id="gane5_<?php echo $row['id']?>"><?php echo $row['gane5']?></td>
    ...
    <?php
      ...
      <td style="vertical-align: middle;" align="center"><?php echo $row['gane']?></td>
      <td style="vertical-align: middle;" align="center"><?php echo $row['data']?></td>
        <td style="vertical-align: middle;" align="center" valign="middle" class="cl6" id="koon<?php echo $row['id']?>"><?php echo $row["koon$t"]?></td>
        <td style="vertical-align: middle;" align="center" class="cl1"><?php echo $row['gane1']?></td>
        <td style="display:none;" id="gane1_<?php echo $row['id']?>">1</td>
        <td style="vertical-align: middle;" align="center" class="cl1"><?php echo $row['gane2']?></td>
        <td style="display:none;" id="gane2_<?php echo $row['id']?>">2</td>
        <td style="vertical-align: middle;" align="center" class="cl1"><?php echo $row['gane3']?></td>
        <td style="display:none;" id="gane3_<?php echo $row['id']?>">3</td>
        <td style="vertical-align: middle;" align="center" class="cl1"><?php echo $row['gane4']?></td>
        <td style="display:none;" id="gane4_<?php echo $row['id']?>">4</td>
        <td style="vertical-align: middle;" align="center" class="cl1"><?php echo $row['gane5']?></td>
