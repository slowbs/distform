...
if (!isAdmin()) {
    ...
    try {
        ...
        foreach($result as $row){
            ...
            $sql = "INSERT INTO year (year) VALUES ({$newep}_$newyear);
            ...
            alter table ap22 add column value_{$newep}_$newyear varchar (10) not null, add column valuekoon{$newep}__$newyear varchar (10) not null, add column valuegane_{$newep}_$newyear varchar (10) not null;
